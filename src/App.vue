<template>
  <Loading :active="isLoading" :z-index="1060">
    <div class="loadingio-spinner-wedges-rkqu80odf0m">
      <div class="ldio-1p09ol9yjzs">
        <div>
          <div><div></div></div>
          <div><div></div></div>
          <div><div></div></div>
...
.ldio-1p09ol9yjzs > div > div {
  transform-origin: 100px 100px;
  animation: ldio-1p09ol9yjzs 3.0303030303030303s linear infinite;
  opacity: 0.8;
}
.ldio-1p09ol9yjzs > div > div > div {
  position: absolute;
  left: 30px;
  top: 30px;
  width: 70px;
...
.ldio-1p09ol9yjzs > div div:nth-child(1) {
