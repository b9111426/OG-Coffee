<template>
  <div>
    <div class="container-fulid">
      <div class="frontCarouse mb-3 bg-primary">
        <div
        ...
        >
          ...
          <div class="carousel-inner text-center">
            ...
            <div class="carousel-item bg-success" data-bs-interval="3000">
              <img
                v-src="
            ...
            <div class="carousel-item" data-bs-interval="3000">
              ...
              <div class="carousel-caption">
                <h3 class="text-dark">阿里山莊園咖啡豆</h3>
                <p class="text-dark fs-4">熱銷強豆</p>
              </div>
            </div>
            <div class="carousel-item" data-bs-interval="3000">
              <img
    ...
    <div class="container">
      <div class="row row-cols-3 bg-success mb-3">
